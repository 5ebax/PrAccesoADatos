...
$(window).on('load', function () {
  ...
  $(".loader-page").css({visibility:"hidden",opacity:"0"})
    ...
    <div class="loader-page"></div>
		...
		<form action="/ProyectoFinalAD/ShowDBServlet" method="get">
		    <p><input class="boton" name="variable" type="submit" value="MySQL"></p>
		 </form>
		<form action="/ProyectoFinalAD/ShowDBServlet" method="post">
		...
		<form action="/ProyectoFinalAD/ShowDBServlet" method="post">
		    <p><input class="botonB" name="variable" type="submit" value="Backup XML"></p>
        </form>
        <% 
		 if( request.getAttribute("nousuarios") != null )
		 {
		    out.print("<p class="+"c"+">No hay datos para mostrar.</p>");
		 }
		 %>
